...
{
	/// <summary>
	///   Use this rule to determine if two objects are equal.
	/// </summary>
	public class AreEqual : Rule
	{
		...
		public AreEqual(string name, string message, object target, object comparisonTarget)
			: base(name, message)
		{
			this.target = target;
		...
		public AreEqual(string name, string message, object target, object comparisonTarget, Severity severity)
			: base(name, message)
		{
			this.target = target;
			this.comparisonTarget = comparisonTarget;
